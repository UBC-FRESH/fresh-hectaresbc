...
1. Complete P8.5 by adding a clean wheel install smoke-test workflow for API and CLI behavior outside the source checkout.
2. Complete P8.6 only after P8.5 is closed and Phase 8 documentation/verification are final.
