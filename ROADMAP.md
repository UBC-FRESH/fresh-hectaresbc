...
1. Complete P11.1 by auditing preview eligibility and selecting representative layers for the first map implementation slice.
2. Work P11.2 through P11.6 one child issue at a time, closing each only after its checklist and verification are complete.
