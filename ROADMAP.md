...
1. Complete P1.4 by classifying representative ZIP payload families and integrity signals.
2. Continue Phase 1 child issues in order where practical: #39, then #35.
