...
1. Complete P4.4 by linking the data repo as `external/fresh-hectaresbc-data`.
2. Complete P4.5 with cold-clone data access validation.
3. Keep future parent issues (#25, #26, #12, #13) as inactive planning placeholders until their phase is explicitly activated.
