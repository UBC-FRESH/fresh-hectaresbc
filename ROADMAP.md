...
1. Complete P12.3 by updating the browser map renderer for source-derived raster PNG overlays.
2. Work P12.4 through P12.5 one child issue at a time, closing each only after its checklist and verification are complete.
